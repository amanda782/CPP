...
int Entidade::ajustarHabilidade(int quantidade) {
	...
	if (habilidade > 12) {
		cout << "A habilidade ultrapassou o limite. Agora, voce possui 12 pontos de habilidade." << endl;
		...
		cout << "Habilidade redefinida. Agora voce possui" << habilidade << "pontos de habilidade." << endl; //imprime a habilidade atual
...
int Entidade::ajustarEnergia(int quantidade) {
	energia += quantidade;
	if (energia > 24) {
		cout << "A energia ultrapassou o limite. Agora, voce possui 24 pontos de energia." << endl;
		...
		cout << "Energia redefinida. Agora voce possui" << energia << "pontos de energia." << endl; //imprime a energia atual
		return 0; // nao sobrou nenhum ponto não utilizado
	}
}
...
int Entidade::ajustarSorte(int quantidade) {
	...
	if (sorte > 12) {
		cout << "A sorte ultrapassou o limite. Agora, voce possui 12 pontos de sorte." << endl;
		...
		cout << "Sorte redefinida. Agora voce possui" << sorte << "pontos de sorte." << endl; //imprime a sorte atual
		return 0; // nao sobrou nenhum ponto não utilizado
	}
